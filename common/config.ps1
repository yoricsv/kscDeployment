...
$Global:KSC = [ordered]@{
    ...
    AuditMariaDbUser    = 'mp10audit'           # Read-only MariaDB account for MaxPatrol VM
    AuditMariaDbBindAddress = '10.20.30.75'     # MariaDB address allowed for remote audit access
